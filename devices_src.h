...
#define MDM_TXD_PIN PC_6
#define MDM_RXD_PIN PC_7
#define MDM_RI_PIN PC_8
#define MDM_DTR_PIN PC_9

#define MDM_VRF_EN_PIN PA_8
#define MDM_PWR_PIN PB_12
#define MDM_RST_PIN PB_13
#define MDM_STATUS_PIN PB_14
#define MDM_FLIGHT_PIN PB_15

#define ECARD_TX_PIN PB_6
#define ECARD_RX_PIN PB_7

#define WDT_WAKE_PIN PA_0
#define WDT_DONE_PIN PA_1
#define USB_DET_PIN PC_13

#define DIPSW_P1_PIN PC_4
#define DIPSW_P2_PIN PC_5
#define DIPSW_P3_PIN PB_0
#define DIPSW_P4_PIN PB_1

#endif

#define firmware_vers "661201"
